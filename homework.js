...
const productItem = new Product('Фен', 400);
...
const postItem = new Post('Семён', 'Просто текст', new Date());
console.log(postItem);
postItem.edit('Отредактированный текст');
console.log(postItem);
...
const attachedItem = new AttachedPost('Василий', 'Новый текст', new Date());
console.log(attachedItem);
attachedItem.makeTextHighlighted();
attachedItem.edit('Отредактированный новый текст');
console.log(attachedItem);
